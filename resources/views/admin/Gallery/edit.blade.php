                        ...
                        <form method='POST' action="{{route('postEditGallery',$gallery->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="title" value="{{$gallery->title}}" class="form-control border border-2 p-2">
                                    @error('title')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    @if($gallery->photo)
                                    <img src="{{asset('site/uploads/category/' .$gallery->photo )}}">
                                    @else
