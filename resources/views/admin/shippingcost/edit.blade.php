<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <x-navbars.sidebar activePage="editshipping"></x-navbars.sidebar>
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method='POST' action="{{ route('postEditShipping', $manageshipping->id) }}"enctype="multipart/form-data">
